...
$(document).ready(function(){
  ...
  body.each(function(){
    ...
    var thiser = $(this) ;
    if($("input:checkbox" , thiser).is(':checked')){
      $("label" , thiser).toggleClass("open") ;
    }
    if( $("input:checkbox" , thiser).is(':disabled') ){
      $("label" , thiser).addClass("disabled") ;
    }
...
/*********************/
//checkbnoxmini plagin
/*********************/

$(document).ready(function(){
  var body = $(".miniCheckbox") ;
  body.each(function(){
